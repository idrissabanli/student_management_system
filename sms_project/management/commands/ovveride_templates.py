...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if os.path.exists(venv_path):
            subprocess.call("rm -rf $(pwd)/sms_project/templates/* && cp -r {}/lib/python{}/site-packages/oscar/templates/oscar/* $(pwd)/sms_project/templates && cd sms_project/templates && tree".format(venv_path, PYTHON_VERSION),shell=True)
