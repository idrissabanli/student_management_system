...
urlpatterns = [
    ...
    path('', include("sms_project.urls"),  name='core'),
...
#     url(r'^', include("sms_project.urls")),
...
admin.site.site_header = 'StudentManagementSystem Admin'
admin.site.site_title = 'StudentManagementSystem Administration'
admin.site.index_title = 'StudentManagementSystem Administration'
