...
SECRET_KEY = "^!ajf1hmi=pr+yd+vk64l+txjk^v_)t0bpvbrqgmb)16!ka8q#{SECRET_KEY}"
...
INSTALLED_APPS = [
    ...
    # 'api.apps.ApiConfig',
    'sms_project.apps.SmsProjectConfig',
]
...
MIDDLEWARE = [
    ...
    'student_management_system.middleware.force_default_middleware.force_default_language_middleware',
